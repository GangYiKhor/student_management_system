...
import { EditFormId, PrintPreviewSize, viewFormValue } from '../constants';
...
export function ReceiptsViewModal({ closeModal, handleUpdate, data }: Readonly<PropType>) {
	const { formData } = useFormContextWithId<FormDataType>(EditFormId);
	...
	return (
		<React.Fragment>
			...
			>
				<Form formId={EditFormId} defaultValue={viewFormValue(data)}>
